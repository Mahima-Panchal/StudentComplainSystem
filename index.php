...
<html lang="en">
  ...
  <section id="mu-service">
    ...
    <section>
        ...
        <p>keep in touch with collage calender</p>
      </div>
  <?php
    include "noticebar.php";  
  ?>
  </section>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
              <div class="mu-footer-widget">
                ...
                <address>
                  ...
                  <p>Phone: 7069006374, 8238088591 </p>
                  <p>Website: www.spu.ac.in</p>
                  <p>Email: info@spu.ac.in</p>
                </address>
              </div>
            </div>
          </div>
	 ...
	 <div class="mu-footer-bottom">
      <div class="container">
        <div class="mu-footer-bottom-area">
          <p>&copy; All Right Reserved. Designed by <a href="http://www.n9ikiswamy.ga/" rel="nofollow">sakalchand patel university</a></p>
        </div>
